...
namespace WowLog\Vendor\Monolog\Handler;

use WowLog\Vendor\Monolog\Formatter\ChromePHPFormatter;
use WowLog\Vendor\Monolog\Formatter\FormatterInterface;
use WowLog\Vendor\Monolog\Level;
use WowLog\Vendor\Monolog\Utils;
use WowLog\Vendor\Monolog\LogRecord;
use WowLog\Vendor\Monolog\DateTimeImmutable;
...
class ChromePHPHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(int|string|Level $level = Level::Debug, bool $bubble = true)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use WowLog\Vendor\Monolog\'s ChromePHPHandler');
        }
    }

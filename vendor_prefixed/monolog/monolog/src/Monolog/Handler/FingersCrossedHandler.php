...
use Closure;
use WowLog\Vendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use WowLog\Vendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use WowLog\Vendor\Monolog\Level;
use WowLog\Vendor\Monolog\Logger;
use WowLog\Vendor\Monolog\ResettableInterface;
use WowLog\Vendor\Monolog\Formatter\FormatterInterface;
use WowLog\Vendor\Psr\Log\LogLevel;

...
namespace WowLog\Vendor\Monolog;

use Closure;
use DateTimeZone;
use Fiber;
use WowLog\Vendor\Monolog\Handler\HandlerInterface;
use WowLog\Vendor\Monolog\Processor\ProcessorInterface;
use WowLog\Vendor\Psr\Log\LoggerInterface;
use WowLog\Vendor\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \WowLog\Vendor\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  value-of<Level::VALUES>|Level $level
